...
art_illumina -i /path/to/mac/reference -p -na -l 250 -f 45 -m 457 -s 4882 -o mac_simulated

art_illumina -i /path/to/mic/reference -p -na -l 250 -f 2 -m 457 -s 4882 -o mic_simulated           
