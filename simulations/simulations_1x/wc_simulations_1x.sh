...
/work/aahowel3/art_bin_MountRainier/art_illumina -i ../mac.genome_nomito.fasta -p -na -l 250 -f 1 -m 457 -s 4882 -o mac_simulated

/work/aahowel3/art_bin_MountRainier/art_illumina -i /storage/reference_genomes/tetrahymena_thermophila/mic/mic.genome.fasta -p -na -l 250 -f 1 -m 457 -s 4882 -o mic_simulated           
